...
if(!empty($_POST)){
    ...
    $data['department'] = json_encode($data['department']);
        ...
        $sql = "insert into user(name,studyNumber,email,college,major,phone,sex,qq,Introduction,note,direction,evaluate) values('".$data['userName']."','".$data['studyNumber']."','".$data['mail']."','".$data['college']."','".$data['major']."','".$data['phoneNumber']."',".$data['userSex'].",'".$data['qqNumber']."','".$data['selfIntro']."','".$data['remark']."',".$data['department'].",'".$data['evaluate']."')";
